...
1. Have you checked both English UK & English US?
2. More voices are available when using ttsreader on a Chrome browser. Specifically - English UK Male is exceptional.
3. Using custom SAPI5 voices is possible on Windows using Firefox browser.
4. We're working on making even more voices available for <a href="/upgrade/" target="_blank">Premium users</a>.
5. On mobile, you will find more voices using our <a href="/mobile/" target="_blank">text-to-speech mobile apps</a>
